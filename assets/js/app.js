...
const CONFIG = {
    ...
    menu: [
        ...
        // --- PART 1 ---
        {
            ...
            items: [
                // LƯU Ý: Tên file 'link' phải viết hoa chữ C (Chapter1.html) giống hệt trên GitHub của bạn
        ...
        // --- PART 2 ---
        {
            ...
            items: [
                ...
                // Bạn tự thêm các Chapter 9->16 vào đây nếu có file...
            ]
        },

        // --- PART 3 ---
        {
            isDropdown: true, id: "part3",
            ...
            items: [
                ...
                // Bạn tự thêm các Chapter 18->25 vào đây nếu có file...
            ]
        },

        // --- PART 4 ---
        {
            isDropdown: true, id: "part4",
        ...
        if (sidebarContainer) {
            ...
            let html = `
                <div class="h-16 flex items-center px-6 border-b border-slate-100 bg-white sticky top-0 z-10">
                    <a href="index.html" title="Quay về trang chủ" class="flex items-center hover:opacity-80 transition-opacity cursor-pointer group">
                        <span class="text-xl font-extrabold text-slate-800 tracking-tight">MBA<span class="text-blue-600">Mastery</span></span>
                        <span class="ml-2 text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity text-xs">↩ Home</span>
                    </a>
                </div>
            ...
            html += `
                <div class="p-4 border-t border-slate-100 bg-slate-50 sticky bottom-0 z-10">
                    <div class="flex items-center gap-3">
                        ...
                        <div><p class="text-xs font-bold text-slate-700">Học viên MBA</p><p class="text-[10px] text-slate-500">Tiến độ: 20%</p></div>
                    </div>
                </div>`;
